...
$(document).ready(function(){
    ...
    if($("body").children(".fade_back").size()==0){
        var feed_back = '<div class="fade_back"><h1><span class="fd_close">�ر�</span>���������ֽ�</h1><div class="fade_area">'+
            '<div class="not_good"><h2>���ʱ��ʲô��ˬ�ģ����������</h2><textarea id="feedback" placeholder="�Ҹ����ǽ�Ŷ..."></textarea></div>'+
            '<div class="leave_name"><h2>Ӣ��������ϵ��ʽ��</h2><textarea id="contact" placeholder="���䡢QQ���ֻ�������..."></textarea></div>' +
            '<a class="fd_btn" id="commit_fd" href="javascript:void(0);"></a></div></div><div class="thanks_fd">��л���������ֽ��Ŷ��Ѿ��յ����������ǿ������ĸ��á�</div>';
...
function selSchool(){
    ...
    if($("#sel-d2").length > 0 && !$("#sel-d2").hasClass("hidden")){
        ...
        $(".optpk-btn a").bind("click",function(){  //����
...
if($(".upload-area").length){
    detectFlash("Ϊ��Ӱ��ͼƬ�ϴ����ܣ���ȡ���������Flash�Ľ���~ ����IE�£�����->��ȫ->ActiveX");
}
